...
class DataBean {
  ...
  DataBean({this.advertesPicture, this.goodInfo, this.goodComments});

  DataBean.fromJson(Map<String, dynamic> json) {
    this.advertesPicture = json['advertesPicture'] != null
        ? AdvertesPictureBean.fromJson(json['advertesPicture'])
        : null;
    this.goodInfo = json['goodInfo'] != null
        ? GoodInfoBean.fromJson(json['goodInfo'])
        : null;
    this.goodComments = (json['goodComments'] as List) != null
        ? (json['goodComments'] as List)
            .map((i) => GoodCommentsListBean.fromJson(i))
            .toList()
        : null;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['goodComments'] = this.goodComments != null
        ? this.goodComments.map((i) => i.toJson()).toList()
        : null;
    return data;
  }
}
...
class GoodCommentsListBean {
  ...
  GoodCommentsListBean(
      {this.comments, this.userName, this.SCORE, this.discussTime});
